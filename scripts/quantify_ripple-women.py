...
# Load dataset
# --------------------------
with open("crossfit-leaderboard-remix/public/leaderboard_data-women.json", "r") as f:
    data = json.load(f)
...
with open("results/jme_displacements-women.json", "w") as f:
...
# Save both
with open("results/jme_top10_displacements-women.json", "w") as f:
